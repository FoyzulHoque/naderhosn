...
class StripeService extends GetxController {
  ...
  Future<String?> _createPaymentIntent(double amount, String currency) async {
    try {
      ...
      EasyLoading.showError(
        'Failed to create payment intent: ${e.response?.statusCode}',
      );
      return null;
    } catch (e) {
  ...
  Future<bool> _processPayment(
    ...
    try {
      ...
      print(
        'Payment successful for transportId: $transportId, cardId: $cardId',
      );
      return true;
    } catch (e) {
  ...
  Future<void> _postPaymentData(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print(
          'Failed to post payment data: ${response.statusCode} - ${response.body}',
        );
        EasyLoading.showError(
